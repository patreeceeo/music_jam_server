    ...
    H.div
        ...
        [ H.div
            ...
            , H.div [ HA.class "f6 f5-ns lh-copy measure mv0 pa2 flex flex-column items-center" ]
                [ viewSelectChordForm handleSubmit model
                ]
            ]
        ]


viewSelectChordForm : Message.Message -> Model -> H.Html Message.Message
viewSelectChordForm onSubmit model =
    H.form
        [ HE.custom "submit" (Json.Decode.succeed { message = onSubmit, preventDefault = True, stopPropagation = True })
        ]
